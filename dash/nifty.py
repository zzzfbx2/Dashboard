...
# Load processed data for Nifty 50
file_path = "processed_data/Nifty_50_Processed.csv"
...
plt.title("Nifty 50 - Forecast for Next 7 Days")
plt.xlabel("Date")
plt.ylabel("Price")
plt.show()
...
forecast[['ds', 'yhat', 'yhat_lower', 'yhat_upper']].to_csv(
    "processed_data/Nifty_Forecast.csv", index=False
)
print("Forecast saved to 'processed_data/Nifty_Forecast.csv'")
